<?php /* Smarty version 3.1.27, created on 2017-01-20 17:32:44
         compiled from "/home/geoyar/domains/geo-yar.ru/public_html/core/components/migx/templates/mgr/grids/migx.grid.tpl" */ ?>
<?php
/*%%SmartyHeaderCode:123287589258821f8ca37722_71960983%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '520b382888a1c71ad690277cdaf7fbdc530f23b0' => 
    array (
      0 => '/home/geoyar/domains/geo-yar.ru/public_html/core/components/migx/templates/mgr/grids/migx.grid.tpl',
      1 => 1484921014,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '123287589258821f8ca37722_71960983',
  'variables' => 
  array (
    'tv' => 0,
    'customconfigs' => 0,
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_58821f8caf0408_50403154',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_58821f8caf0408_50403154')) {
function content_58821f8caf0408_50403154 ($_smarty_tpl) {

$_smarty_tpl->properties['nocache_hash'] = '123287589258821f8ca37722_71960983';
?>
...
_gridDD',
		...
		,tbar: [
        <?php if ($_smarty_tpl->tpl_vars['customconfigs']->value['disable_add_item'] != '1') {?>
        {
            text: '[[%migx.add]]',
...
').dom.value = '';     
	...
	,addItem: function(btn,e) {
	    var maxRecords =  parseInt('<?php echo $_smarty_tpl->tpl_vars['customconfigs']->value['maxRecords'];?>
');
        var add_items_directly = '<?php echo $_smarty_tpl->tpl_vars['customconfigs']->value['add_items_directly'];?>
';
        var s=this.getStore();
...
';
        var object_id = '<?php echo $_smarty_tpl->tpl_vars['request']->value['object_id'];?>
';
...
');
		...
		this.loadWindow(btn,e,{
            ...
            ,object_id: object_id
            ,co_id: co_id
            ,title: '<?php echo $_smarty_tpl->tpl_vars['customconfigs']->value['iframeWindowTitle'];?>
'
            ,iframeTpl: tpl
        });
    } 
